...
namespace avance1Proyecto3 {
	...
	/// <summary>
	/// Resumen de OpcionesClienteVisita
	/// </summary>
	public ref class OpcionesClienteVisita : public System::Windows::Forms::Form
	{
	public:
		OpcionesClienteVisita(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button4->Click += gcnew System::EventHandler(this, &OpcionesClienteVisita::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &OpcionesClienteVisita::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &OpcionesClienteVisita::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &OpcionesClienteVisita::button1_Click);
			// 
			// OpcionesClienteVisita
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(8, 16);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(135, 137);
			this->Controls->Add(this->button4);
			this->Controls->Add(this->button3);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->button1);
			this->FormBorderStyle = System::Windows::Forms::FormBorderStyle::None;
			this->Name = L"OpcionesClienteVisita";
			this->Text = L"OpcionesClienteVisita";
